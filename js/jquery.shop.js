(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Fruit Market-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.currencyString = "Rs"; // Currency symbol as textual string
			...
			this.paypalURL = "https://phonepe.freshdesk.com/en/support/login"; // The URL of the PayPal's form
